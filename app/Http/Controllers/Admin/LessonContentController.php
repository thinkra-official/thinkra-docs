...
class LessonContentController extends Controller
{
    ...
    public function autosaveSection(
        ...
        Log::info('Admin LessonContentController@autosaveSection hit', [
            'courseId' => $courseId,
            'sectionId' => $sectionId,
            'lessonId' => $lessonId,
        ]);
    ...
    public function autosave(
        ...
        Log::info('Admin LessonContentController@autosave hit', [
            'courseId' => $courseId,
            'sectionId' => $sectionId,
    ...
    public function showVersionSection(
        ...
        Log::info('Admin LessonContentController@showVersionSection hit', [
            'courseId' => $courseId,
            'sectionId' => $sectionId,
            'lessonId' => $lessonId,
            'versionId' => $versionId,
    ...
    public function showVersion(
        ...
        Log::info('Admin LessonContentController@showVersion hit', [
            'courseId' => $courseId,
            'sectionId' => $sectionId,
            'subSectionId' => $subSectionId,
            'lessonId' => $lessonId,
    ...
    public function restoreSection(
        ...
        Log::info('Admin LessonContentController@restoreSection hit', [
            'courseId' => $courseId,
            'sectionId' => $sectionId,
            'lessonId' => $lessonId,
            'versionId' => $versionId,
    ...
    public function restore(
        ...
        Log::info('Admin LessonContentController@restore hit', [
            'courseId' => $courseId,
            'sectionId' => $sectionId,
            'subSectionId' => $subSectionId,
            'lessonId' => $lessonId,
