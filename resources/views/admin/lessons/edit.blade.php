...
@php
    ...
    if ($inSubSection) {
        ...
        $statusRoute = 'admin.courses.lessons.status';
        $updateRoute = 'admin.courses.lessons.update';
        $destroyRoute = 'admin.courses.lessons.destroy';
        $autosaveRoute = 'admin.courses.lessons.autosave';
        $versionShowRoute = 'admin.courses.lessons.versions.show';
        $versionRestoreRoute = 'admin.courses.lessons.versions.restore';
    } else {
        ...
        $statusRoute = 'admin.courses.section-lessons.status';
        $updateRoute = 'admin.courses.section-lessons.update';
        $destroyRoute = 'admin.courses.section-lessons.destroy';
        $autosaveRoute = 'admin.courses.section-lessons.autosave';
        $versionShowRoute = 'admin.courses.section-lessons.versions.show';
        $versionRestoreRoute = 'admin.courses.section-lessons.versions.restore';
    }
    ...
    $lessonEditUrl = $inSubSection
        ? route('admin.courses.lessons.edit', $lessonRoute)
        : route('admin.courses.section-lessons.edit', $lessonRoute);
@endphp
    ...
    <div x-show="tab === 'edit'" x-cloak>
        <form method="POST" action="{{ $lessonUpdateUrl }}" class="space-y-5" id="lesson-form">
            ...
            <div class="thinkra-card p-5 border-amber-200/80 bg-amber-50/30">
                ...
                <p class="text-xs text-amber-700/80 mb-2">خاصة بالمعلمين والإدارة فقط.</p>
...
<script src="{{ asset('js/lesson-editor.js') }}?v={{ file_exists($p = public_path('js/lesson-editor.js')) ? filemtime($p) : time() }}"></script>
@endpush
@endsection
